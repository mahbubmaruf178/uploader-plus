...
function se(_, e, t) {
  ...
  if (
    (arguments.length > 2 &&
      (l.children = arguments.length > 3 ? M.call(arguments, 2) : t),
...
function B(_) {
  ((!_.__d && (_.__d = !0) && x.push(_) && !H.__r++) ||
    J !== h.debounceRendering) &&
    ((J = h.debounceRendering) || Y)(H);
}
function H() {
  var _, e, t, i, n, r, l, s;
...
function ne(_, e, t, i, n, r, l, s, c, u, p) {
  var o,
    ...
    y = (i && i.__k) || ee,
    a = e.length;
  for (t.__d = c, ue(t, e, y), c = t.__d, o = 0; o < a; o++)
    (f = t.__k[o]) != null &&
      typeof f != "boolean" &&
      typeof f != "function" &&
      ((m = f.__i === -1 ? T : y[f.__i] || T),
      (f.__i = o),
      z(_, f, m, n, r, l, s, c, u, p),
      (v = f.__e),
      f.ref &&
        m.ref != f.ref &&
        (m.ref && q(m.ref, null, f), p.push(f.ref, f.__c || v, f)),
      g == null && v != null && (g = v),
    ...
    (l = i + o),
      (n = _.__k[i] =
        (n = e[i]) == null || typeof n == "boolean" || typeof n == "function"
          ...
          ? U(null, n, null, null, null)
          : I(n)
          ? U(N, { children: n }, null, null, null)
          : n.constructor === void 0 && n.__b > 0
          ? U(n.type, n.props, n.key, n.ref ? n.ref : null, n.__v)
          : n) != null
        ? ((n.__ = _),
          (n.__b = _.__b + 1),
          (s = ce(n, t, l, p)),
          ...
          r == null || r.__v === null
            ? (s == -1 && o--, typeof n.type != "function" && (n.__u |= 65536))
            : s !== l &&
              (s == l - 1
                ? (o = s - l)
                : s == l + 1
        ...
        : (r = t[l]) &&
          ...
          r.__e &&
          !(131072 & r.__u) &&
          (r.__e == _.__d && (_.__d = C(r)), V(r, r, !1), (t[l] = null), p--);
  if (p)
    for (i = 0; i < u; i++)
      (r = t[i]) != null &&
        !(131072 & r.__u) &&
        (r.__e == _.__d && (_.__d = C(r)), V(r, r));
}
function oe(_, e, t) {
  var i, n;
  if (typeof _.type == "function") {
    for (i = _.__k, n = 0; i && n < i.length; n++)
      i[n] && ((i[n].__ = _), (e = oe(i[n], e, t)));
    return e;
  }
  _.__e != e &&
    (e && _.type && !t.contains(e) && (e = C(_)),
...
function K(_, e, t) {
  e[0] === "-"
    ? _.setProperty(e, t ?? "")
    : (_[e] =
        t == null ? "" : typeof t != "number" || le.test(e) ? t : t + "px");
}
  ...
  e: if (e === "style")
    if (typeof t == "string") _.style.cssText = t;
      ...
      if ((typeof i == "string" && (_.style.cssText = i = ""), i))
        for (e in i) (t && e in t) || K(_.style, e, "");
    ...
    (r = e !== (e = e.replace(/(PointerCapture)$|Capture$/i, "$1"))),
      ...
      t
        ? i
          ? (t.u = i.u)
          : ((t.u = j), _.addEventListener(e, r ? O : $, r))
        : _.removeEventListener(e, r ? O : $, r);
  else {
...
function z(_, e, t, i, n, r, l, s, c, u) {
  ...
  128 & t.__u && ((c = !!(32 & t.__u)), (r = [(s = e.__e = t.__e)])),
    (p = h.__b) && p(e);
  e: if (typeof k == "function")
    try {
      if (
        ...
        if (
          (d &&
            ...
            o.componentWillReceiveProps(a, w),
          !o.__e &&
            ((o.shouldComponentUpdate != null &&
              o.shouldComponentUpdate(a, o.__s, w) === !1) ||
              e.__v === t.__v))
        ) {
          for (
            e.__v !== t.__v && ((o.props = a), (o.state = o.__s), (o.__d = !1)),
              e.__e = t.__e,
              e.__k = t.__k,
      ...
      (o.state = o.__s),
        ...
        d &&
          ...
          (g = o.getSnapshotBeforeUpdate(f, v)),
        ne(
          _,
          I(
            (A =
              p != null && p.type === N && p.key == null ? p.props.children : p)
          )
            ? A
            : [A],
          e,
    ...
    r == null && e.__v === t.__v
      ...
      : (e.__e = pe(t.__e, e, t, i, n, r, l, c, u));
  (p = h.diffed) && p(e);
}
function re(_, e, t) {
  e.__d = void 0;
...
function pe(_, e, t, i, n, r, l, s, c) {
  ...
  if (d === null) y === a || (s && _.data === a) || (_.data = a);
    ...
    if (((r = r && M.call(_.childNodes)), (y = t.props || T), !s && r != null))
      for (y = {}, u = 0; u < _.attributes.length; u++)
    ...
    if (p)
      ...
      ne(
        ...
        t,
        i,
        d === "foreignObject" ? "http://www.w3.org/1999/xhtml" : n,
        r,
        l,
        r ? r[0] : t.__k && C(t, 0),
        s,
      ...
      for (u = r.length; u--; ) r[u] != null && _e(r[u]);
    s ||
      ((u = "value"),
      v !== void 0 &&
        (v !== _[u] ||
...
function de(_, e, t) {
  ...
  h.__ && h.__(_, e),
    ...
    z(
      e,
      (_ = ((!i && t) || e).__k = se(N, null, [_])),
      n || T,
      T,
      e.namespaceURI,
      !i && t ? [t] : n ? null : e.firstChild ? M.call(e.childNodes) : null,
      r,
...
function ye(_, e, t) {
  ...
  for (r in (_.type && _.type.defaultProps && (l = _.type.defaultProps), e))
    r == "key"
      ...
      : r == "ref"
      ? (n = e[r])
      : (s[r] = e[r] === void 0 && l !== void 0 ? l[r] : e[r]);
  return (
    arguments.length > 2 &&
      (s.children = arguments.length > 3 ? M.call(arguments, 2) : t),
        ...
        this.getChildContext ||
          ...
          (this.sub = function (l) {
            ...
            l.componentWillUnmount = function () {
              n && n.splice(n.indexOf(l), 1), s && s.call(l);
            };
          })),
        i.children
      );
          ...
          try {
            if (
              ...
              n.componentDidCatch != null &&
                (n.componentDidCatch(_, i || {}), (l = n.__d)),
              l)
            )
              return (n.__E = n);
          } catch (s) {
